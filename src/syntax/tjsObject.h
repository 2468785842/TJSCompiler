...
#define TJS_SELECT_OBJTHIS(__closure__, __override__) \
    ...
    public:
        tTJSDispatch();
        ~tTJSDispatch() override;

        //	bool DestructionTrace;

        tjs_uint TJS_INTF_METHOD AddRef() override;
        tjs_uint TJS_INTF_METHOD Release() override;

    protected:
        [[nodiscard]] tjs_uint GetRefCount() const { return RefCount; }
    ...
    public:
        ...
        tjs_error TJS_INTF_METHOD
        EnumMembers(tjs_uint32 flag, tTJSVariantClosure* callback, iTJSDispatch2* objthis) override {
            return TJS_E_NOTIMPL;
        }
...
#define TJS_MAX_NATIVE_CLASS 4
    ...
    */
        ...
        struct tTJSSymbolData {
            ...
            */
            ...
            void _SetName(const tjs_char* name) {
                if (Name) Name->Release(), Name = nullptr;
            ...
            void PostClear() {
                if (Name) Name->Release(), Name = nullptr;
                reinterpret_cast<tTJSVariant*>(&Value)->~tTJSVariant();
            ...
            bool NameMatch(const tjs_char* name) const {
    ...
    private:
        ...
        virtual void CheckObjectClosureAdd(const tTJSVariant& val) {
            ...
            if (val.Type() == tvtObject) {
                ...
                if (dsp == static_cast<iTJSDispatch2*>(this)) this->Release();
            }
        }

        virtual void CheckObjectClosureRemove(const tTJSVariant& val) {
            if (val.Type() == tvtObject) {
                iTJSDispatch2* dsp = val.AsObjectClosureNoAddRef().ObjThis;
                if (dsp == static_cast<iTJSDispatch2*>(this)) this->AddRef();
            }
        }
    ...
    public:
        ...
        FuncCall(tjs_uint32 flag, const tjs_char* membername, tjs_uint32* hint,
                 tTJSVariant* result,
                 tjs_int numparams, tTJSVariant** param, iTJSDispatch2* objthis) override;
        ...
        tjs_error TJS_INTF_METHOD
        ClassInstanceInfo(tjs_uint32 flag, tjs_uint num, tTJSVariant* value) override;
    };
