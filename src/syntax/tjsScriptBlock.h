...
namespace TJS {
    ...
    public:
        ...
        // for Bytecode
        static constexpr int BYTECODE_FILE_TAG_SIZE = 8;
    ...
    public:
        ...
        tjs_uint GetContextCount() const { return static_cast<tjs_uint>(InterCodeContextList.size()); }
        ...
        [[nodiscard]] bool IsReusable() const {
            return GetContextCount() == 1 &&
                TopLevelContext != nullptr && !UsingPreProcessor;
        }
    ...
    private:
        ...
        // for Bytecode
        static constexpr int BYTECODE_TAG_SIZE = 4;
        static constexpr int BYTECODE_CHUNK_SIZE_LEN = 4;
        ...
        static void Write4Byte(tjs_uint8 output[4], int value) {
            output[0] = static_cast<tjs_uint8>(value >> 0 & 0xff);
            output[1] = static_cast<tjs_uint8>(value >> 8 & 0xff);
            output[2] = static_cast<tjs_uint8>(value >> 16 & 0xff);
            output[3] = static_cast<tjs_uint8>(value >> 24 & 0xff);
        }

        void ExportByteCode(bool outputdebug, tTJSBinaryStream* output);
