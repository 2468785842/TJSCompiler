    ...
    public:
        ...
        void Persist(tjs_uint8* dest) {
            *(tjs_uint*)dest = Length;
            if (Data)
                memcpy(dest + sizeof(tjs_uint), Data, Length);
        }
    };
...
/*]*/
    ...
    public:
        tTJSVariantClosure() {
        } // note that default constructor does nothing
    ...
    public:
        ...
        TJS_METHOD_DEF(TJS_METHOD_RET_EMPTY, tTJSVariant, (iTJSDispatch2 *ref)): tTJSVariant_S() // from Object
        {
            if (ref) ref->AddRef();
            vt = tvtObject;
            Object.Object = ref;
        ...
        TJS_METHOD_DEF(TJS_METHOD_RET_EMPTY, tTJSVariant,
                       (iTJSDispatch2 *obj, iTJSDispatch2 *objthis)) : tTJSVariant_S() // from closure
        {
            if (obj) obj->AddRef();
            if (objthis) objthis->AddRef();
            vt = tvtObject;
        ...
        TJS_METHOD_DEF(TJS_METHOD_RET_EMPTY, tTJSVariant, (const tjs_char *ref)): tTJSVariant_S() //  from String
        {
            vt = tvtString;
            if (ref) {
        ...
        TJS_METHOD_DEF(TJS_METHOD_RET_EMPTY, tTJSVariant, (const tTJSString & ref)) : tTJSVariant_S() // from tTJSString
        {
            vt = tvtString;
        ...
        TJS_METHOD_DEF(TJS_METHOD_RET_EMPTY, tTJSVariant, (const tjs_nchar *ref)) : tTJSVariant_S()
        //  from NarrowString
        {
            vt = tvtString;
            if (ref) {
        ...
        TJS_METHOD_DEF(TJS_METHOD_RET_EMPTY, tTJSVariant, (const tjs_uint8 *ref, tjs_uint len)) : tTJSVariant_S()
        // from octet
        {
            vt = tvtOctet;
            if (ref) {
	...
	tTJSVariant(const WideString ref) // from WideString
	{
        ...
        TJS_METHOD_DEF(TJS_METHOD_RET_EMPTY, tTJSVariant, (bool ref)) : tTJSVariant_S() {
            vt = tvtInteger;
            Integer = (tjs_int64)(tjs_int)ref;
        }

        TJS_METHOD_DEF(TJS_METHOD_RET_EMPTY, tTJSVariant, (tjs_int32 ref)) : tTJSVariant_S() {
            vt = tvtInteger;
            Integer = (tjs_int64)ref;
        }

        TJS_METHOD_DEF(TJS_METHOD_RET_EMPTY, tTJSVariant, (tjs_int64 ref)) : tTJSVariant_S() // from Integer64
        {
            vt = tvtInteger;
            Integer = ref;
        }

        TJS_METHOD_DEF(TJS_METHOD_RET_EMPTY, tTJSVariant, (tjs_real ref)): tTJSVariant_S() // from double
        {
            vt = tvtReal;
            TJSSetFPUE();
            Real = ref;
	...
	void AttachTo(WideString &ws)
	{
        ...
        TJS_CONST_METHOD_DEF(tTJSVariantOctet *, AsOctet, ()) {
            switch (vt) {
            case tvtVoid: return NULL;
            case tvtOctet: { if (Octet) Octet->AddRef(); }
                return Octet;
            case tvtString:
            case tvtInteger:
            case tvtReal:
	...
	operator AnsiString () const
	{
        ...
        TJS_CONST_METHOD_DEF(void, AsNumber, (tTJSVariant &targ)) {
            switch (vt) {
            case tvtVoid: targ = (tjs_int)0;
                return;
            case tvtObject: TJSThrowVariantConvertError(*this, tvtInteger, tvtReal);
            case tvtString: String->ToNumber(targ);
                return;
            case tvtInteger: targ = Integer;
                return;
            case tvtReal: TJSSetFPUE();
                targ = Real;
                return;
